jQuery(
    (function ($) {
        ...
        $(".panther-slider").owlCarousel({
            ...
            responsivee: { 0: { items: 2 }, 570: { items: 2 }, 768: { items: 4 }, 992: { items: 3 }, 1200: { items: 4 } },
        });
        $(".panther-slider-two").owlCarousel({
            ...
            autoplayHoverPause: true,
            navText: ["<i class='bx bx-chevron-left'></i>", "<i class='bx bx-chevron-right'></i>"],
            responsivee: { 0: { items: 2 }, 570: { items: 3 }, 768: { items: 3 }, 992: { items: 4 }, 1200: { items: 5 } },
        });
        ...
        $(".experts-slider").owlCarousel({
            ...
            autoplayHoverPause: true,
            navText: ["<i class='bx bx-chevron-left'></i>", "<i class='bx bx-chevron-right'></i>"],
            responsivee: { 0: { items: 1 }, 570: { items: 2 }, 768: { items: 2 }, 992: { items: 3 }, 1200: { items: 3 } },
        });
        $(".portfolio-slider").owlCarousel({
            ...
            autoplayHoverPause: true,
            navText: ["<i class='bx bx-chevron-left'></i>", "<i class='bx bx-chevron-right'></i>"],
            responsivee: { 0: { items: 1 }, 570: { items: 2 }, 768: { items: 2 }, 992: { items: 3 }, 1200: { items: 4 } },
        });
        ...
        $(".testimonials-slider").owlCarousel({
            ...
            responsivee: { 0: { items: 1 }, 570: { items: 1 }, 768: { items: 2 }, 992: { items: 1 }, 1200: { items: 1 } },
        });
        $(".testimonials-three-slider").owlCarousel({
            ...
            autoplayHoverPause: true,
            navText: ["<i class='bx bx-chevron-left'></i>", "<i class='bx bx-chevron-right'></i>"],
            responsivee: { 0: { items: 1 }, 570: { items: 1 }, 768: { items: 2 }, 992: { items: 2 }, 1200: { items: 2 } },
        });
        ...
        const settings = { fill: "#F76031", background: "transparent" };
